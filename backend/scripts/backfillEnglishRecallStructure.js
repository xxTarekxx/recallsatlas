...
const OUTPUT_PATH_DEFAULT = path.join(SCRIPTS_ROOT, "recalls.english.cleaned.json");
const HASH_PATH_DEFAULT = path.join(SCRIPTS_ROOT, "backfillEnglishRecallStructure.hashes.json");
const LOG_PATH_DEFAULT = path.join(SCRIPTS_ROOT, "backfillEnglishRecallStructure.run-log.json");
