        ...
        <div className="home-hero-inner" dir={heroDir} lang={lang}>
          <div className="home-hero-grid">
            <div className="home-hero-copy">
              <p className="home-hero-kicker">RecallGraph AI search</p>

              <h1 id="hero-heading" className="home-hero-title">
                Search recalls by meaning
              </h1>

              <p className="home-hero-subtitle">
                Describe a hazard, product, company, or ingredient. RecallGraph finds related
                public recall records even when the exact words do not match.
              </p>
              ...
              <p className="home-semantic-note">
                {semanticSearchReady
                  ? "Semantic ranking is live and every result links back to its public source record."
                  : "The semantic-search interface is ready; vector ranking activates when the pgvector database is connected."}
              </p>
            </div>

            <aside className="home-ai-panel" aria-label="RecallGraph live index summary">
              <div className="home-ai-panel-header">
                <span className="home-ai-panel-kicker">Live recall index</span>
                <span className="home-ai-panel-status">
                  {semanticSearchReady ? "semantic ranking on" : "vector-ready"}
                </span>
              </div>

              <dl className="home-ai-index-list">
                <div>
                  <dt>{recallsCountText}</dt>
                  <dd>{t.statRecalls}</dd>
                </div>
                <div>
                  <dt>{t.statSourcesValue}</dt>
                  <dd>Public sources</dd>
                </div>
                <div>
                  <dt>Source-backed</dt>
                  <dd>Open each match and verify the public record.</dd>
                </div>
              </dl>

              <Link className="home-ai-panel-link" href="/recallgraph/dashboard">
                View data dashboard
              </Link>
            </aside>
          </div>
